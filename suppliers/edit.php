...
<div class="card p-4" style="max-width:560px">
  ...
  <form method="post" novalidate>
    ...
    <div class="mb-3"><label class="form-label">Phone</label>
      <input type="tel" name="phone" class="form-control" placeholder="e.g. 0771234567 or +94771234567" value="<?php echo htmlspecialchars($_POST['phone'] ?? $sup['phone']); ?>"></div>
    <div class="mb-3"><label class="form-label">Email</label>
      <input type="email" name="email" class="form-control" placeholder="supplier@example.com" value="<?php echo htmlspecialchars($_POST['email'] ?? $sup['email']); ?>"></div>
